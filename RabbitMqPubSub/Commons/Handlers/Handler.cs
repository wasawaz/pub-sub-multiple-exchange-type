...
namespace RabbitMqPubSub.Commons.Handlers
{
	public class Handler : IHandler
	{
        ...
        private Func<RabbitMqPubSubException, Task> _onCustomError;
        ...
        public IHandler OnCustomError(Func<RabbitMqPubSubException, Task> onCustomError, bool rethrow = false)
        {
        ...
        public async Task ExecuteAsync()
        {
            ...
            catch (RabbitMqPubSubException customException)
            {
                isFailure = true;
